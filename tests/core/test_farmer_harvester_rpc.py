...
from profit.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult, PlotRefreshEvents
from profit.plotting.manager import PlotManager
from profit.protocols import farmer_protocol
from profit.rpc.farmer_rpc_api import FarmerRpcApi
from profit.rpc.farmer_rpc_client import FarmerRpcClient
from profit.rpc.harvester_rpc_api import HarvesterRpcApi
from profit.rpc.harvester_rpc_client import HarvesterRpcClient
...
from profit.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            assert config["farmer"]["gl_target_address"] == encode_puzzle_hash(new_ph, "profit")
            assert config["pool"]["gl_target_address"] == encode_puzzle_hash(new_ph_3, "profit")
