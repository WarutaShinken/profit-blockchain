...
from profit.wallet.puzzles.p2_conditions import puzzle_for_conditions
from profit.wallet.puzzles import singleton_top_layer
from profit.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - profit.pools.pool_puzzles.py
    - profit.wallet.puzzles.pool_member_innerpuz.clvm
    - profit.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
