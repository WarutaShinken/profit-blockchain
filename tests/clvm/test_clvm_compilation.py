...
from profit.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "profit/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "profit/wallet/puzzles/cc.clvm",
        "profit/wallet/puzzles/chialisp_deserialisation.clvm",
        "profit/wallet/puzzles/rom_bootstrap_generator.clvm",
        "profit/wallet/puzzles/generator_for_single_coin.clvm",
        "profit/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "profit/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "profit/wallet/puzzles/lock.inner.puzzle.clvm",
        "profit/wallet/puzzles/p2_conditions.clvm",
        "profit/wallet/puzzles/p2_delegated_conditions.clvm",
        "profit/wallet/puzzles/p2_delegated_puzzle.clvm",
        "profit/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "profit/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "profit/wallet/puzzles/p2_puzzle_hash.clvm",
        "profit/wallet/puzzles/rl_aggregation.clvm",
        "profit/wallet/puzzles/rl.clvm",
        "profit/wallet/puzzles/sha256tree_module.clvm",
        "profit/wallet/puzzles/singleton_top_layer.clvm",
        "profit/wallet/puzzles/did_innerpuz.clvm",
        "profit/wallet/puzzles/decompress_puzzle.clvm",
        "profit/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "profit/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "profit/wallet/puzzles/block_program_zero.clvm",
        "profit/wallet/puzzles/test_generator_deserialize.clvm",
        "profit/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "profit/wallet/puzzles/p2_singleton.clvm",
        "profit/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "profit/wallet/puzzles/pool_member_innerpuz.clvm",
        "profit/wallet/puzzles/singleton_launcher.clvm",
        "profit/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["profit/wallet/puzzles/create-lock-puzzlehash.clvm", "profit/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "profit/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to profit/wallet/puzzles, but not added to `wallet_program_files`
        """
