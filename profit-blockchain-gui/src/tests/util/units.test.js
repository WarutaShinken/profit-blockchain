...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of profit', () => {
      const result = units.getUnit('profit');
    ...
    it('gets unit of profit using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of profit', () => {
      const result = units.getDisplay('profit');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('profit', 9);

      const result = units.getUnit('profit');

      expect(result).toEqual(9);

      units.setUnit('profit', 1);
    });
  });
  describe('#setDisplay', () => {
    ...
    it('updates an existing display', () => {
      units.setDisplay('profit', {
        format: '{amount} TPROFIT',
        fractionDigits: 0,
      });
