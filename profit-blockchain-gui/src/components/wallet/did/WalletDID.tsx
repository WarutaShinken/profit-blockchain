...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@profit/core';
import {
...
import { mojo_to_profit_string } from '../../../util/profit';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_profit_string(props.balance)} TPROFIT
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'profit_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'profit_addr://') {
