...
import { /* mojo_to_profit_string, */ profit_to_mojo } from '../../../util/profit';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_profit_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of profit in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Profit that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Profit that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send profit to coloured address. Please enter a profit
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'profit_addr://') {
    ...
    const amountValue = Number.parseFloat(profit_to_mojo(amount));
    const feeValue = Number.parseFloat(profit_to_mojo(fee));
