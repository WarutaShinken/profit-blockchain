...
import { AlertDialog, ConfirmDialog } from '@profit/core';
        ...
        <DialogContent>
          ...
          {keyring_state.can_save_passphrase && (
            <Box display="flex" alignItems="center">
              ...
              />
              <Tooltip title={t`Your passphrase can be stored in your system's secure credential store. Profit will be able to access your keys without prompting for your passphrase.`}>
