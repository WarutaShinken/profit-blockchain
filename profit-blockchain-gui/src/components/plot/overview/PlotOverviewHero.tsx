...
import { CardHero, Flex, Link } from '@profit/core';
import { PlotHero as PlotHeroIcon } from '@profit/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Profit. '
              }
              <Link
                target="_blank"
                href="https://github.com/ProfitCrypto/profit-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
