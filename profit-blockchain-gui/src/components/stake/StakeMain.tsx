...
export default function StakeMain() {
    ...
    function dealSearchResult(records:any[]):string {
      ...
      let total_profit: number = mojo_to_profit(total);
      return "Staking Balance: " + total_profit.toLocaleString();
    }
    ...
    return (
        <Flex flexDirection="column" gap={3}>
          ...
          Please select your staking address and send PROFIT to it.
          </Typography>
