...
````bash
~/.profit/<currentversion>/config/ssl/daemon/private_daemon.crt
~/.profit/<currentversion>/config/ssl/daemon/private_daemon.key
````
...
````bash
~/.profit/<currentversion>/config/ssl/ui/
~/.profit/<currentversion>/config/ssl/ui/
````
