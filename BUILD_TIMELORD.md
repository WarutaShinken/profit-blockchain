...
required to run a [Timelord](https://github.com/ProfitCrypto/profit-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/ProfitCrypto/profit-blockchain/blob/main/install-timelord.sh)
