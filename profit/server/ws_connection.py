...
from profit.cmds.init_funcs import profit_full_version_str
from profit.protocols.protocol_message_types import ProtocolMessageTypes
from profit.protocols.protocol_state_machine import message_response_ok
from profit.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from profit.protocols.shared_protocol import Capability, Handshake
from profit.server.outbound_message import Message, NodeType, make_msg
from profit.server.rate_limits import RateLimiter
...
from profit.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from profit.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSProfitConnection:
    """
