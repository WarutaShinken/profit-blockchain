...
from profit.consensus.block_rewards import calculate_base_farmer_reward
from profit.consensus.coinbase import create_puzzlehash_for_pk
from profit.pools.pool_puzzles import SINGLETON_MOD_HASH, create_p2_singleton_puzzle
from profit.pools.pool_wallet import PoolWallet
from profit.pools.pool_wallet_info import FARMING_TO_POOL, PoolState, PoolWalletInfo, create_pool_state
from profit.protocols.protocol_message_types import ProtocolMessageTypes
from profit.server.outbound_message import NodeType, make_msg
...
from profit.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from profit.util.path import path_from_root
from profit.util.ws_message import WsRpcMessage, create_payload_dict
...
from profit.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from profit.wallet.util.trade_utils import trade_record_to_dict
from profit.wallet.util.transaction_type import TransactionType
from profit.wallet.util.wallet_types import WalletType
from profit.wallet.wallet_info import WalletInfo
from profit.wallet.wallet_node import WalletNode
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from profit.pools.pool_wallet_info import initial_pool_state_from_dict
