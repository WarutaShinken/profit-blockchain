...
from profit.plotting.create_plots import resolve_plot_keys
from profit.plotters.plotters_util import run_plotter, run_command
...
def get_madmax_executable_path_for_ksize(plotters_root_path: Path, ksize: int = 32) -> Path:
    ...
    madmax_exec: str = "profit_plot"
    if ksize > 32:
        madmax_exec += "_k34"  # Use the profit_plot_k34 executable for k-sizes > 32
    ...
    if is_madmax_supported():
        ...
        run_command(
            [
                "git",
                "clone",
                "https://github.com/ProfitCrypto/profit-plotter-madmax.git",
                MADMAX_PLOTTER_DIR,
            ],
