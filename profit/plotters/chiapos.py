"""
NOTE: This contains duplicate code from `profit.cmds.plots`.
After `profit plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Profit Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_profit(args, root_path):
