...
from profit.consensus.cost_calculator import calculate_cost_of_program, NPCResult
...
from profit.wallet.puzzles.puzzle_utils import (
...
from profit.wallet.secret_key_store import SecretKeyStore
from profit.wallet.sign_coin_spends import sign_coin_spends
...
class Wallet:
    ...
    async def create_spend_bundle_relative_profit(self, profit_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if profit_amount < 0:
            utxos = await self.select_coins(abs(profit_amount), exclude)
        else:
        ...
        profit_amount = spend_value + profit_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": profit_amount}]
