...
#   python profit/utils/profiler.py ~/.profit/mainnet/profile | less -r
...
#   python profit/utils/profiler.py ~/.profit/mainnet/profile 10 20
...
if __name__ == "__main__":
    ...
    def analyze_slot_range(profile_dir: pathlib.Path, first: int, last: int):
        ...
        output_file = "profit-hotspot-%d" % first
        if first < last:
            output_file += "-%d" % last
