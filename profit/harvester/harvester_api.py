...
from profit.harvester.harvester import Harvester
from profit.plotting.util import PlotInfo, parse_plot_info
from profit.protocols import harvester_protocol
from profit.protocols.farmer_protocol import FarmingInfo
from profit.protocols.harvester_protocol import Plot
from profit.protocols.protocol_message_types import ProtocolMessageTypes
from profit.server.outbound_message import make_msg
...
from profit.util.ints import uint8, uint32, uint64
from profit.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSProfitConnection
    ):
        """
