...
from profit.consensus.network_type import NetworkType
from profit.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from profit.farmer.farmer import Farmer
from profit.protocols import farmer_protocol, harvester_protocol
from profit.protocols.harvester_protocol import PoolDifficulty
...
from profit.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSProfitConnection
    ):
        """
    ...
    @api_request
    @peer_required
    async def new_signage_point(self, new_signage_point: farmer_protocol.NewSignagePoint, peer: ws.WSProfitConnection):
        try:
    ...
    @api_request
    @peer_required
    async def respond_plots(self, _: harvester_protocol.RespondPlots, peer: ws.WSProfitConnection):
