...
from profit.cmds.wallet_funcs import print_balance, wallet_coin_unit
from profit.pools.pool_wallet_info import PoolWalletInfo, PoolSingletonState
...
async def create(args: dict, wallet_client: WalletRpcClient, fingerprint: int) -> None:
    ...
    fee_mojos = uint64(int(fee * units["profit"]))
