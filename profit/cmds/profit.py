...
from profit.cmds.configure import configure_cmd
from profit.cmds.farm import farm_cmd
from profit.cmds.init import init_cmd
from profit.cmds.keys import keys_cmd
from profit.cmds.netspace import netspace_cmd
from profit.cmds.passphrase import passphrase_cmd
from profit.cmds.plotnft import plotnft_cmd
from profit.cmds.plots import plots_cmd
from profit.cmds.plotters import plotters_cmd
from profit.cmds.show import show_cmd
from profit.cmds.start import start_cmd
from profit.cmds.stop import stop_cmd
from profit.cmds.wallet import wallet_cmd
from profit.util.default_root import DEFAULT_KEYS_ROOT_PATH, DEFAULT_ROOT_PATH
from profit.util.keychain import set_keys_root_path, supports_keyring_passphrase
from profit.util.ssl_check import check_ssl
...
def cli(
    ...
    if passphrase_file is not None:
        from profit.cmds.passphrase_funcs import cache_passphrase, read_passphrase_from_file
...
if not supports_keyring_passphrase():
    from profit.cmds.passphrase_funcs import remove_passphrase_options_from_cmd
...
def run_daemon_cmd(ctx: click.Context, wait_for_unlock: bool) -> None:
    ...
    from profit.daemon.server import async_run_daemon
