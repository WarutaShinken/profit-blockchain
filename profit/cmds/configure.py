...
from profit.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "49444"
            # testnet_introducer = "beta1_introducer.profitcrypto.net"
            # testnet_dns_introducer = "dns-introducer-testnet7.profitcrypto.net"
            testnet = "testnet"
            ...
            mainnet_port = "48444"
            # mainnet_introducer = "introducer.profitcrypto.net"
            # mainnet_dns_introducer = "dns-introducer.profitcrypto.net"
            net = "mainnet"
