...
def show_plots(root_path: Path):
    from profit.plotting.util import get_plot_directories
...
def create_cmd(
    ...
    from profit.plotting.create_plots import create_plots, resolve_plot_keys
...
def check_cmd(
    ...
    from profit.plotting.check_plots import check_plots
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from profit.plotting.util import remove_plot_directory
