...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	...
	echo "https://github.com/ProfitCrypto/profit-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
echo "https://keybase.io/team/profit_network.public"
echo ""
echo "Try the Quick Start Guide to running profit-blockchain:"
echo "https://github.com/ProfitCrypto/profit-blockchain/wiki/Quick-Start-Guide"
echo ""
